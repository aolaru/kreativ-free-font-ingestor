...
class KFI_Admin_UI {
	...
	public function sanitize_settings( $input ) {
		return array(
			...
			'import_limit'             => isset( $input['import_limit'] ) ? max( 1, absint( $input['import_limit'] ) ) : 2,
	...
	public function render_import_limit_field() {
		...
		<p class="description"><?php esc_html_e( 'Batch size for manual and scheduled imports. Default: 2 fonts every 8 hours.', 'kreativ-font-ingestor' ); ?></p>
		<?php
	}
